...
<head>
  ...
  <title>EvanozDev - Dashboard</title>
...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" style="background-color: #20124D;" href="index.php">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
            ...
            <div class="col-12 text-center">
              <h2 class="font-weight-bold text-uppercase text-dark" style="font-family: Tahoma, Verdana;">SELAMAT DATANG&nbsp;<?= $username;?>!</h2>
            </div>
