...
// TANGKAP DATA YANG DIKIRIM METHOD GET
$id = $_GET["id"];

// SELECT SLIDE SHOW
$slide = query("SELECT * FROM slide_data WHERE id = $id")[0];

// INSERT SLIDE SHOW
if ( isset($_POST["submit"]) ) {
  if (update($_POST) > 0) {
    echo "<script>
            alert('Berhasil Mengubah Slide!');
          </script>";
    echo "<script>
...
<head>
  ...
  <title>EvanozDev - Update Slide-Show</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Slide Show</h1>
            <ol class="breadcrumb">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            <div class="row" id="ghosting">
                  ...
                  <div class="card-body">
                    <div class="row d-flex flex-column align-items-center">
                      <div class="col w-100 mb-4">
                        <img id="previewImage" class="rounded" src="../../resources/slide/<?= $slide["gambar"];?>" alt="Preview Image" width="100%">
                      </div>
                      <div class="col w-100">
                    ...
                    <div class="row d-flex flex-column align-items-center">
                      <div class="col w-100">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control ttl-input" id="title-slide" name="title" placeholder="Masukkan judul slide" value="<?= $slide["judul"];?>">
                        </div>
                        <div class="mb-3">
                          <label for="desc-slide" class="form-label ttl-label font-weight-bold">DESKRIPSI SLIDE</label>
                          <textarea type="text" class="form-control ttl-input" id="desc-slide" name="deskripsi" placeholder="Masukkan deskripsi slide" rows="5"><?= $slide["deskripsi"];?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-xl-12 col-md-6 mb-4">
                ...
                <a href="slide_show.php" class="btn btn-cancel">CANCEL</a>
              </div>
            </div>
          </form>
