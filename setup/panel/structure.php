...
// SELECT DATA
$structures = query("SELECT * FROM structure_data ORDER BY id DESC");



if ( isset($_POST["cari"]) ) {
  $structures = cari($_POST["keyword"]);
}
...
if ( isset($_POST["submit"]) ) {
  if (insert($_POST) > 0) {
    echo "<script>
            alert('Berhasil Menambahkan Divisi Baru!');
          </script>";
    echo "<script>
    ...
    echo "<script>
            alert('Gagal Menambahkan Divisi Baru!');
          </script>";
    echo "<script>
            document.location.href = 'structure.php';
          </script>";
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" style="background-color: #20124D;" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="img/logo/lego.png">
        </div>
        <div class="sidebar-brand-text mx-3">EvanozDev</div>
      </a>
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row" id="sembunyi">
            <div class="col-xl-12 col-md-6 mb-4">
                <button id="create" class="btn font-weight-bold" style="background-color: #2A2E65; color: white;">TAMBAHKAN DIVISI BARU</button>
            </div>
            <div class="col-xl-12 col-md-6 mb-2">
              <div class="text-dark">Structure Terunggah</div>
            </div>
                ...
                <div class="card h-100">
                  <div class="card-body">
                    <div class="row d-flex flex-column align-items-center justify-content-center">
                      <div class="col w-50 mb-4">
                        <img src="../../resources/structures/<?= $str["gambar"];?>" alt="" class="rounded-circle border" width="100%">
                      </div>
                      <div class="col col1 w-100 mb-2 d-flex flex-wrap justify-content-center align-items-center text-center border rounded p-2">
                        <h5 class="font-weight-bold"><?= $str["nama"];?></h2>
                      </div>
                      <div class="col col2 w-100 d-flex flex-wrap justify-content-center align-items-center text-center border p-2">
                        <h5 class="font-weight-bold"><?= $str["divisi"];?></h2>
                      </div>

                      <ul class="cocial-linked mb-2">
                      ...
                      <div class="col w-100 d-flex flex-row">
                        <a href="update_str.php?id=<?= $str["id"];?>" class="btn btn-primary w-100 m-1" style="margin-right: 5px; width: 50%;">UPDATE</a>
                        <a href="delete_str.php?id=<?= $str["id"];?>" class="btn btn-danger w-100 m-1" style="margin-left: 5px; width: 50%;">DELETE</a>
                      </div>
                    </div>
                  </div> 
                </div>
                  ...
                  <div class="card-body">
                    <div class="row d-flex flex-column align-items-center">
                      <div class="col w-100 mb-2">
                        <p class="text-center">Harap Upload Foto Dengan Rasio 1:1!</p>
                      </div>
                      <div class="col w-100 mb-4">
                        <img id="previewImage" class="rounded-circle" src="#" alt="Preview Image" width="100%" style="display: none;">
                      </div>
                      <div class="col w-100">
                    ...
                    <div class="row d-flex flex-column align-items-center">
                      <div class="col w-100">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control ttl-input" id="title-blog" name="nama" placeholder="Masukkan nama">
                        </div>
                        <div class="mb-4">
                          <label for="desc-blog" class="form-label ttl-label font-weight-bold">DIVISI / TANGGUNG JAWAB</label>
                          <input type="text" class="form-control ttl-input" id="desc-blog" name="divisi" placeholder="Masukkan jabatan atau divisi">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control ttl-input" id="desc-blog" name="instagram" placeholder="Masukkan tautan instagram">
                        </div>
                        <div class="mb-3">
                          <label for="desc-blog" class="form-label ttl-label font-weight-bold">FACEBOOK LINK</label>
                          <input type="text" class="form-control ttl-input" id="desc-blog" name="facebook" placeholder="Masukkan tautan facebook">
                        </div>
                        <div class="mb-3">
                          <label for="desc-blog" class="form-label ttl-label font-weight-bold">LINKEDIN LINK</label>
                          <input type="text" class="form-control ttl-input" id="desc-blog" name="linkedin" placeholder="Masukkan tautan linkedin">
                        </div>
                        <div class="mb-3">
                          <label for="desc-blog" class="form-label ttl-label font-weight-bold">TIKTOK LINK</label>
                          <input type="text" class="form-control ttl-input" id="desc-blog" name="tiktok" placeholder="Masukkan tautan tiktok">
                        </div>
                      </div>
                    </div>
                  </div>
